...
namespace B3.Graphics.VertexStructures {
	...
	public struct Vertex2PCT : IVertexAttributable, IConvertable<Vertex3PC>, IConvertable<Vertex3PCTN> {
		...
		/// <summary>Converts the object into the target convertable object</summary>
		/// <returns>Returns the converted object</returns>
		Vertex3PCTN IConvertable<Vertex3PCTN>.Convert() { return new Vertex3PCTN(this.position.ToVector3(), this.color, this.texcoord, Vector3.Zero); }
