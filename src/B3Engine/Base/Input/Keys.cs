...
namespace B3 {
	/// <summary>An enumeration of all the keys on a keyboard</summary>
	public enum Keys : int {
		/// <summary>If the key is unknown</summary>
		Unknown = -1,
		...
		NumPadDivide,
		/// <summary>The Multiply key on the number pad</summary>
		NumPadMultiply,
		/// <summary>The Subtract key on the number pad</summary>
		NumPadSubtract,
		/// <summary>The Add key on the number pad</summary>
		NumPadAdd,
		/// <summary>The Enter key on the number pad</summary>
		NumPadEnter,
		...
		NumPad0,
		/// <summary>The Decimal key on the number pad</summary>
		NumPadDecimal,
